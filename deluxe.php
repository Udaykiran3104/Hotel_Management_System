...
<html>
	...
	<body style="background: #EFE1D1;">
		...
		<br>
		<h2 class="r_room">Deluxe Rooms</h2><br>
                            <div class="row">
  			<div class="column">
    			<img src="images/d1.jpg" alt="Snow" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="images/d2.jpg" alt="Forest" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="Images/d3.jpg" alt="Mountains" style="width:100%">
  			</div>
		</div><br>
		<div class="row">
  			<div class="column">
    			<img src="images/d4.jpg" alt="Snow" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="images/d5.jpg" alt="Forest" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="images/d6.jpg" alt="Mountains" style="width:100%">
  			</div>
		</div><br>
		<div class="row">
  			<div class="column">
    			<img src="images/d7.jpg" alt="Snow" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="images/d8.jpg" alt="Forest" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="images/d9.jpg" alt="Mountains" style="width:100%">
  			</div>
		</div><br><br><br>
