...
<html>
	...
	<body style="background: #EFE1D1;">
		...
		<h2 class="r_room">Standard Rooms</h2><br>
                            <div class="row">
  			<div class="column">
    			<img src="images/s11.jpg" alt="Snow" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="images/s2.jpg" alt="Forest" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="Images/s3.jpg" alt="Mountains" style="width:100%">
  			</div>
		</div><br>
		<div class="row">
  			<div class="column">
    			<img src="images/s4.jpg" alt="Snow" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="images/s5.jpg" alt="Forest" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="images/s61.jpg" alt="Mountains" style="width:100%">
  			</div>
		</div><br>
		<div class="row">
  			<div class="column">
    			<img src="images/s7.jpg" alt="Snow" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="images/s8.jpg" alt="Forest" style="width:100%">
  			</div>
  			<div class="column">
    			<img src="images/s9.jpg" alt="Mountains" style="width:100%">
  			</div>
		</div><br><br><br>
